...
export function defaultProps(theme) {
  return {
    MuiAlert: {
      defaultProps: {
        iconMapping: {
          error: <Iconify icon={ic.dangerBold} width={24} />,
          info: <Iconify icon={ic.infoFill} width={24} />,
          success: <Iconify icon={ic.checkmarkCircleFill} width={24} />,
          warning: <Iconify icon={ic.alertTriangleFill} width={24} />,
        },
      },
    },
    MuiStack: {
    ...
    MuiChip: {
      defaultProps: {
        deleteIcon: <Iconify icon={ic.closeCircleBold} />,
      },
    },
    MuiDialogActions: {
      defaultProps: {
    ...
    // Lab `@mui/lab/TreeView` is removed; use `SimpleTreeView` / `TreeItem` from `@mui/x-tree-view`.
    MuiSimpleTreeView: {
      defaultProps: {
        slots: {
      ...
      defaultProps: {
        slots: {
          ...
          columnSortedAscendingIcon: () => (
            <Iconify width={20} icon={ic.altArrowUpBoldDuotone} sx={{ color: 'text.primary' }} />
          ),
          columnSortedDescendingIcon: () => (
            <Iconify width={20} icon={ic.altArrowDownBoldDuotone} sx={{ color: 'text.primary' }} />
          ),
          columnUnsortedIcon: () => (
            <Iconify width={20} icon={ic.altArrowUpBoldDuotone} sx={{ color: 'text.disabled' }} />
          ),
          columnMenuIcon: () => <Iconify width={20} icon={ic.more1Fill} />,
          columnMenuSortAscendingIcon: () => <Iconify width={20} icon={ic.altArrowUpBoldDuotone} />,
          columnMenuSortDescendingIcon: () => (
            <Iconify width={20} icon={ic.altArrowDownBoldDuotone} />
          ),
          columnMenuFilterIcon: () => <Iconify width={20} icon={ic.filterBold} />,
          columnMenuHideIcon: () => <Iconify width={20} icon={ic.eyeClosedBold} />,
          columnMenuManageColumnsIcon: () => <Iconify width={20} icon={ic.eyeBold} />,
          columnSelectorIcon: () => <Iconify width={20} icon={ic.eyeBold} />,
          // filter
          filterPanelDeleteIcon: () => <Iconify width={20} icon={ic.closeFill} />,
          openFilterButtonIcon: () => <Iconify width={20} icon={ic.filterBold} />,
          columnFilteredIcon: () => (
            <Iconify width={16} icon={ic.filterBold} sx={{ color: 'text.primary' }} />
          ),
          // density
          densityCompactIcon: () => <Iconify width={20} icon={ic.tableRowsNarrowRounded} />,
          densityStandardIcon: () => <Iconify width={20} icon={ic.rows4Fill} />,
          densityComfortableIcon: () => <Iconify width={20} icon={ic.rows2Fill} />,
          // export
          exportIcon: () => <Iconify width={20} icon={ic.exportBold} />,
          // quick filter
          quickFilterIcon: () => (
            <Iconify width={24} icon={ic.searchFill} sx={{ color: 'text.secondary' }} />
          ),
          quickFilterClearIcon: () => <Iconify width={20} icon={ic.closeFill} />,
        },
        slotProps: {
          basePopper: {
