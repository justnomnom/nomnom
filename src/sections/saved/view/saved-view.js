...
import { fetchMyListsHub } from 'src/auth/actions/list-actions';
...
export default function SavedView() {
  ...
  const filteredEmptyCopy = useMemo(() => {
    if (filter === 'shared') {
      return {
        title: t('pages.dashboard.saved.empty_shared_title'),
        body: t('pages.dashboard.saved.empty_shared_body'),
      };
    }
    if (filter === 'from_others') {
      return {
        title: t('pages.dashboard.saved.empty_from_others_title'),
        body: t('pages.dashboard.saved.empty_from_others_body'),
      };
    }
    if (filter === 'subscriptions') {
      return {
        title: t('pages.dashboard.saved.empty_subscriptions_title'),
        body: t('pages.dashboard.saved.empty_subscriptions_body'),
      };
    }
    return {
      title: t('pages.dashboard.saved.empty_lists_title'),
      body: t('pages.dashboard.saved.empty_lists_body'),
    };
  }, [filter, t]);
  ...
  return (
    <SettingsDrillShell
      title={t('pages.dashboard.saved.page_heading')}
      ...
      <Box sx={{ ...dashboardPageRootSx, minWidth: 0, overflowX: 'hidden' }}>
        <DashboardPageMotion stagger>
          <Stack {...dashboardSubsectionStackProps}>
            {!loading && (
              <DashboardMotionSection>
                <Typography variant="body2" color="text.secondary" sx={{ maxWidth: 560 }}>
                  {t('pages.dashboard.saved.subtitle_lists')}
                </Typography>
                {visitSummary?.saved ? (
                  <Typography
                    variant="caption"
                  ...
                  >
                    {t('pages.dashboard.saved.visit_summary', {
            ...
            {!loading && !err && (
              <DashboardMotionSection>
                <Box role="group" aria-label={t('pages.dashboard.saved.lists_filter_aria')}>
                  <ScrollableChipRow gap={1} sx={{ mx: 0, width: 1 }}>
                    ...
                    >
                      {t('pages.dashboard.saved.filter_lists_all')}
                    </Button>
                    <Button
                      color="inherit"
                      disableElevation
                    ...
                    >
                      {t('pages.dashboard.saved.filter_lists_own')}
                    </Button>
                    <Button
                      color="inherit"
                      disableElevation
                    ...
                    >
                      {t('pages.dashboard.saved.filter_lists_following')}
                    </Button>
                    <Button
                      color="inherit"
                      disableElevation
                    ...
                    >
                      {t('pages.dashboard.saved.filter_lists_subscriptions')}
                    </Button>
                    <Button
                      color="inherit"
                      disableElevation
                    ...
                    >
                      {t('pages.dashboard.saved.filter_lists_shared')}
                    </Button>
                  </ScrollableChipRow>
                </Box>
              </DashboardMotionSection>
