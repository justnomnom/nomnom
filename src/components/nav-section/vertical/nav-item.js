  ...
  (
    ...
    const renderContent = (
      <StyledNavItem
        ...
        {...other}
      >
        {!subItem && (bottomNavIconify || icon) && (
          <Box component="span" className="icon">
            {bottomNavIconify ? (
              <Iconify
                width={24}
                icon={active ? bottomNavIconify.active : bottomNavIconify.inactive}
                sx={{ color: 'inherit' }}
              />
            ) : (
              icon
        ...
        {hasChild && (
          <Iconify
            width={16}
            className="arrow"
            icon={open ? ic.arrowIosDownwardFill : ic.arrowIosForwardFill}
            sx={{ color: 'inherit' }}
          />
        )}
      </StyledNavItem>
...
NavItem.propTypes = {
  ...
  bottomNavIconify: PropTypes.shape({
