...
/**
 * Resolve a color-preset id to a primary palette.
 * Unknown / stale localStorage values fall back to brand default so
 * `alpha(primary.main, …)` never receives undefined.
 */
export function getPrimary(preset) {
  return PRIMARY_PRESETS[preset] ?? PRIMARY_PRESETS.default;
}
