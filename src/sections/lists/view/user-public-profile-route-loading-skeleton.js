...
export default function UserPublicProfileRouteLoadingSkeleton() {
  ...
  /** One slot matches own-profile toolbar; others show two icons — single placeholder avoids wrong count flash. */
  ...
  return (
    ...
    >
      <Box data-testid="e2e-dashboard-user-public-profile-loading" sx={{ width: 1 }}>
        <SettingsDrillShell
          title=""
          compactToolbar
          useHistoryBack
