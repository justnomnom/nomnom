...
/**
 * TinaCMS Git-backed schema for MDX collections. Run `npm run tina:build` after edits.
 * Set NEXT_PUBLIC_TINA_CLIENT_ID and TINA_TOKEN from tina.io for cloud editing.
 */
  ...
  schema: {
    collections: [
      ...
      },
      {
        ...
        ui: {
          router: ({ document }) => {
            const d = document as { country?: string; _sys: { filename: string } };
