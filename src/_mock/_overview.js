import { ic, svgIcon } from 'src/assets/icons';
...
export const _appRelated = ['Chrome', 'Drive', 'Dropbox', 'Evernote', 'Github'].map(
  (name, index) => {
    ...
    const shortcut =
      (name === 'Chrome' && svgIcon.app('ic_chrome')) ||
      (name === 'Drive' && svgIcon.app('ic_drive')) ||
      (name === 'Dropbox' && svgIcon.app('ic_dropbox')) ||
      (name === 'Evernote' && svgIcon.app('ic_evernote')) ||
      svgIcon.app('ic_github');
...
export const _appInstalled = ['Germany', 'England', 'France', 'Korean', 'USA'].map(
  (name, index) => ({
    ...
    flag: [ic.flagDe, ic.flagGbNir, ic.flagFr, ic.flagKr, ic.flagUs][index],
  })
);
...
export const _ecommerceBestSalesman = [...Array(5)].map((_, index) => {
  ...
  const flag = [ic.flagDe, ic.flagGbNir, ic.flagFr, ic.flagKr, ic.flagUs][index];
