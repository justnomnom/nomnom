...
export const contentInlineLinkClassName = `font-medium text-primary underline underline-offset-2 ${contentLinkFocusVisible}`;

/** Primary inline link, semibold + always underlined. */
export const contentInlineLinkSemiboldUnderlineClassName = `font-semibold text-primary underline ${contentLinkFocusVisible}`;

/** Primary inline link, semibold + underline on hover only. */
export const contentInlineLinkSemiboldHoverUnderlineClassName = `font-semibold text-primary underline-offset-2 hover:underline ${contentLinkFocusVisible}`;
...
export const contentRestaurantCardCtaLinkClassName = `mt-4 inline-block text-sm font-semibold text-primary underline-offset-4 hover:underline ${contentLinkFocusVisible}`;

/** Breadcrumb trail links (muted until hover). */
export const contentBreadcrumbNavLinkClassName = `hover:text-primary hover:underline ${contentLinkFocusVisible}`;
...
export const contentCountryIndexCardLinkClassName = `block rounded-2xl border border-border bg-muted/80 p-5 font-semibold capitalize text-primary outline-none transition hover:border-primary/50 ${contentLinkFocusVisible}`;
...
export const contentViewAllCreatorsLinkClassName = `inline-flex rounded-full border border-dashed border-border px-3 py-1 text-sm font-medium text-primary outline-none transition-colors hover:border-primary/40 ${contentLinkFocusVisible}`;
