...
export const ANALYTICS_EVENT_SCHEMAS = {
  ...
  activation_checklist_shown: { required: [] },
  activation_checklist_dismissed: { required: [] },
  activation_item_completed: { required: ['item'] },
  discover_first_feed_viewed: { required: ['restaurant_count'] },
